...
public class LibrarianSignUp extends CredentialsOfSqlServer implements ActionListener{
	...
	int id = 11;
	static String QUERY = "SELECT max(librarianID) from librarian;";
	...
	LibrarianSignUp(){
	    ...
	    salary.setBounds(50,200, 200,30);    
	    panel.add(salary);
	    
	    password.setBounds(50,250, 200,30);    
	    panel.add(password);
		
		sign.setBounds(50,300,200,40);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==sign) {
	        ...
	        try(Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
	                ...
	                String sql = "INSERT INTO librarian (librarianID, librarianName, librarianAddress, librarianPassword,librarianSalary)" +
	                        " VALUES ("+id+",'"+name.getText()+"', '"+mail.getText()+"', '"+password.getText()+"','"+salary.getText()+"')";
