...
public class LibrarianLogin extends CredentialsOfSqlServer implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == login) {
			...
			QUERY = "SELECT * FROM PUMA.LIBRARIAN WHERE EXISTS (SELECT * FROM puma.librarian WHERE librarianAddress = '"+username2+"' AND librarianPassword = '"+password2+"');";
			...
			LibrarianSignUp s = new LibrarianSignUp();
